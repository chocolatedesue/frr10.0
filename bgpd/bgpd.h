...
enum bgp_af_index {
	...
	BGP_AF_IPV4_LINK_STATE,
	BGP_AF_IPV6_LINK_STATE,
	BGP_AF_MAX
};
...
static inline int afindex(afi_t afi, safi_t safi)
{
	...
	case AFI_IP:
		...
		case SAFI_BGP_LINK_STATE:
			return BGP_AF_IPV4_LINK_STATE;
...
static inline int peer_afi_active_nego(const struct peer *peer, afi_t afi)
{
	if (peer->afc_nego[afi][SAFI_UNICAST]
	    ...
	    || peer->afc_nego[afi][SAFI_BGP_LINK_STATE]
...
static inline int peer_group_af_configured(struct peer_group *group)
{
	...
	if (peer->afc[AFI_IP][SAFI_UNICAST] || peer->afc[AFI_IP][SAFI_MULTICAST]
	    ...
	    || peer->afc[AFI_IP][SAFI_BGP_LINK_STATE]
	    ...
	    || peer->afc[AFI_IP6][SAFI_BGP_LINK_STATE]
